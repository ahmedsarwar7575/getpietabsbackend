...
export const createTab2Form = async (req: Request, res: Response) => {
...
// Get all Tab2Forms
export const getAllTab2Forms = async (req: Request, res: Response) => {
    try {
...
export const getTab2FormById = async (req: Request, res: Response) => {
    try {
        const { id } = req.params;
...
// Update a Tab2Form
export const updateTab2Form = async (req: Request, res: Response) => {
    try {
        const { id } = req.params;
...
// Delete a Tab2Form
export const deleteTab2Form = async (req: Request, res: Response) => {
    try {
        const { id } = req.params;
        const form = await Tab2Form.findByPk(id);
        if (!form) {
