...
export const createTab6Form = async (req: Request, res: Response) => {
    const { id } = req.params
    try {
...
// Get all Tab1Forms
export const getAllTab6Forms = async (req: Request, res: Response) => {
    try {
...
export const getTab6FormById = async (req: Request, res: Response) => {
    try {
        const { id } = req.params;
...
// Update a Tab1Form
export const updateTab6Form = async (req: Request, res: Response) => {
    try {
        const { id } = req.params;
...
// Delete a Tab1Form
export const deleteTab6Form = async (req: Request, res: Response) => {
    try {
        const { id } = req.params;
        const form = await Tab6Form.findByPk(id);
        if (!form) {
