...
export const createTab1Form = async (req, res) => {
    try {
...
// Get all Tab1Forms
export const getAllTab1Forms = async (req, res) => {
    try {
...
export const getTab1FormById = async (req, res) => {
    try {
        const { id } = req.params;
...
// Update a Tab1Form
export const updateTab1Form = async (req, res) => {
    try {
        const { id } = req.params;
...
// Delete a Tab1Form
export const deleteTab1Form = async (req, res) => {
    try {
        const { id } = req.params;
        const form = await Tab1Form.findByPk(id);
        if (!form) {
